...
// checks if the ProductSearchResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductSearchResult{}

// ProductSearchResult struct for ProductSearchResult
...
func (o ProductSearchResult) MarshalJSON() ([]byte, error) {
...
func (o ProductSearchResult) ToMap() (map[string]interface{}, error) {
...
type NullableProductSearchResult struct {
	value *ProductSearchResult
	isSet bool
}

func (v NullableProductSearchResult) Get() *ProductSearchResult {
	return v.value
}

func (v *NullableProductSearchResult) Set(val *ProductSearchResult) {
	v.value = val
	v.isSet = true
}

func (v NullableProductSearchResult) IsSet() bool {
	return v.isSet
}

func (v *NullableProductSearchResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductSearchResult(val *ProductSearchResult) *NullableProductSearchResult {
	return &NullableProductSearchResult{value: val, isSet: true}
}

func (v NullableProductSearchResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductSearchResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
