...
// checks if the OrganizationLegalAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationLegalAddress{}

// OrganizationLegalAddress struct for OrganizationLegalAddress
type OrganizationLegalAddress struct {
	// Nombre de la calle
...
func (o *OrganizationLegalAddress) GetNeighborhood() string {
...
func (o OrganizationLegalAddress) MarshalJSON() ([]byte, error) {
...
func (o OrganizationLegalAddress) ToMap() (map[string]interface{}, error) {
...
type NullableOrganizationLegalAddress struct {
	value *OrganizationLegalAddress
	isSet bool
}

func (v NullableOrganizationLegalAddress) Get() *OrganizationLegalAddress {
	return v.value
}

func (v *NullableOrganizationLegalAddress) Set(val *OrganizationLegalAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationLegalAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationLegalAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationLegalAddress(val *OrganizationLegalAddress) *NullableOrganizationLegalAddress {
	return &NullableOrganizationLegalAddress{value: val, isSet: true}
}

func (v NullableOrganizationLegalAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationLegalAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
