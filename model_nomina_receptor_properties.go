...
// checks if the NominaReceptorProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NominaReceptorProperties{}

// NominaReceptorProperties Información del trabajador.
type NominaReceptorProperties struct {
	// CURP del trabajador.
...
func (o NominaReceptorProperties) MarshalJSON() ([]byte, error) {
...
func (o NominaReceptorProperties) ToMap() (map[string]interface{}, error) {
...
type NullableNominaReceptorProperties struct {
	value *NominaReceptorProperties
	isSet bool
}

func (v NullableNominaReceptorProperties) Get() *NominaReceptorProperties {
	return v.value
}

func (v *NullableNominaReceptorProperties) Set(val *NominaReceptorProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableNominaReceptorProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableNominaReceptorProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNominaReceptorProperties(val *NominaReceptorProperties) *NullableNominaReceptorProperties {
	return &NullableNominaReceptorProperties{value: val, isSet: true}
}

func (v NullableNominaReceptorProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNominaReceptorProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
