...
// checks if the InvoicePropertiesAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoicePropertiesAddress{}

// InvoicePropertiesAddress struct for InvoicePropertiesAddress
type InvoicePropertiesAddress struct {
	// Nombre de la calle
...
func (o *InvoicePropertiesAddress) GetNeighborhood() string {
...
func (o InvoicePropertiesAddress) MarshalJSON() ([]byte, error) {
...
func (o InvoicePropertiesAddress) ToMap() (map[string]interface{}, error) {
...
type NullableInvoicePropertiesAddress struct {
	value *InvoicePropertiesAddress
	isSet bool
}

func (v NullableInvoicePropertiesAddress) Get() *InvoicePropertiesAddress {
	return v.value
}

func (v *NullableInvoicePropertiesAddress) Set(val *InvoicePropertiesAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoicePropertiesAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoicePropertiesAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoicePropertiesAddress(val *InvoicePropertiesAddress) *NullableInvoicePropertiesAddress {
	return &NullableInvoicePropertiesAddress{value: val, isSet: true}
}

func (v NullableInvoicePropertiesAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoicePropertiesAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
