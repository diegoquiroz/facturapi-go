...
// checks if the OrganizationSearchResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationSearchResult{}

// OrganizationSearchResult struct for OrganizationSearchResult
...
func (o OrganizationSearchResult) MarshalJSON() ([]byte, error) {
...
func (o OrganizationSearchResult) ToMap() (map[string]interface{}, error) {
...
type NullableOrganizationSearchResult struct {
	value *OrganizationSearchResult
	isSet bool
}

func (v NullableOrganizationSearchResult) Get() *OrganizationSearchResult {
	return v.value
}

func (v *NullableOrganizationSearchResult) Set(val *OrganizationSearchResult) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationSearchResult) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationSearchResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationSearchResult(val *OrganizationSearchResult) *NullableOrganizationSearchResult {
	return &NullableOrganizationSearchResult{value: val, isSet: true}
}

func (v NullableOrganizationSearchResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationSearchResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
