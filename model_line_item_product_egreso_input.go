...
// checks if the LineItemProductEgresoInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LineItemProductEgresoInput{}

// LineItemProductEgresoInput struct for LineItemProductEgresoInput
type LineItemProductEgresoInput struct {
...
func NewLineItemProductEgresoInput() *LineItemProductEgresoInput {
	this := LineItemProductEgresoInput{}
...
func (o LineItemProductEgresoInput) MarshalJSON() ([]byte, error) {
...
func (o LineItemProductEgresoInput) ToMap() (map[string]interface{}, error) {
...
type NullableLineItemProductEgresoInput struct {
	value *LineItemProductEgresoInput
	isSet bool
}

func (v NullableLineItemProductEgresoInput) Get() *LineItemProductEgresoInput {
	return v.value
}

func (v *NullableLineItemProductEgresoInput) Set(val *LineItemProductEgresoInput) {
	v.value = val
	v.isSet = true
}

func (v NullableLineItemProductEgresoInput) IsSet() bool {
	return v.isSet
}

func (v *NullableLineItemProductEgresoInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLineItemProductEgresoInput(val *LineItemProductEgresoInput) *NullableLineItemProductEgresoInput {
	return &NullableLineItemProductEgresoInput{value: val, isSet: true}
}

func (v NullableLineItemProductEgresoInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLineItemProductEgresoInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
