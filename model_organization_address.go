...
// checks if the OrganizationAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationAddress{}
...
func (o *OrganizationAddress) GetNeighborhood() string {
...
func (o OrganizationAddress) ToMap() (map[string]interface{}, error) {
