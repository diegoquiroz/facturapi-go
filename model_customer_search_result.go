...
// checks if the CustomerSearchResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerSearchResult{}

// CustomerSearchResult struct for CustomerSearchResult
...
func (o CustomerSearchResult) MarshalJSON() ([]byte, error) {
...
func (o CustomerSearchResult) ToMap() (map[string]interface{}, error) {
...
type NullableCustomerSearchResult struct {
	value *CustomerSearchResult
	isSet bool
}

func (v NullableCustomerSearchResult) Get() *CustomerSearchResult {
	return v.value
}

func (v *NullableCustomerSearchResult) Set(val *CustomerSearchResult) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerSearchResult) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerSearchResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerSearchResult(val *CustomerSearchResult) *NullableCustomerSearchResult {
	return &NullableCustomerSearchResult{value: val, isSet: true}
}

func (v NullableCustomerSearchResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerSearchResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
